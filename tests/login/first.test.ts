...
describe("Login form", function () {
  ...
  it("Add button, pozitive", async function () {
    (await driver.findElement(By.css('md-tab-item:nth-child(2)'))).click();
    await driver.sleep(500);
    (await driver.findElement(By.css('[ng-model="ctrl.unit.hour"]'))).click();
    await driver.sleep(500);
    (await driver.findElement(By.css('[ng-model="ctrl.unit.hour"] option:nth-child(2)'))).click();
    await driver.sleep(500);
    (await driver.findElement(By.css('[ng-model="ctrl.unit.minute"]'))).click();
    await driver.sleep(500);
    (await driver.findElement(By.css('[ng-model="ctrl.unit.minute"] option:nth-child(2)'))).click();
    await driver.sleep(500);
    (await driver.findElement(By.css('[ng-click="ctrl.save()"]'))).click();
    await driver.sleep(500);
...
//   }
  ...
  // it("Add, Positive test", async function () {
  //   browser.go(App.url);
  //   await page.isLoad();
